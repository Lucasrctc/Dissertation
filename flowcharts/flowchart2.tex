...
\node [terminator, fill=blue!20, text width=3.5cm] at (12,0) (qc) {\textbf{Quantum-Classical\\Hybrid Algorithm}};
%\node [process, fill=red!20] at (3.5,-5) (error) {Error};
%\node [process, fill=green!20] at (0,-8) (success) {Success};
\node [terminator, fill=blue!20] at (15.2,0) (end) {\textbf{Solution}};
